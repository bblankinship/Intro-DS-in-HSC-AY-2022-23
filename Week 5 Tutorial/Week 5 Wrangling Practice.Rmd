...
As we discussed in the tutorial, mutate and summarise are similar though distinct functions. Change the summarise function below to be mutate instead - what do you expect to see? 
